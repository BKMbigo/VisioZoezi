object Desktop {
    ...
    const val webcamCapture = "com.github.sarxos:webcam-capture:${Versions.webcamCapture}"

    const val deepLearningTensorflowModelZoo =
        "ai.djl.tensorflow:tensorflow-model-zoo:${Versions.deepLearningJava}"
    const val deepLearningTensorflowEngine =
